...
public class Consultation {
	...
	*/
	public Consultation(Patient patient, Doctor doctor, LocalDateTime consultationDate,Product product) {
    ...
    private Product product;  // Added Product entity association
