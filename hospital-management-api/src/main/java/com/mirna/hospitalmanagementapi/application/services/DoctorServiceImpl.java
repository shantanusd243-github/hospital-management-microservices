...
import com.mirna.hospitalmanagementapi.domain.dtos.DepartmentDTO;
...
public class DoctorServiceImpl implements DoctorService {
	...
	public Doctor addDoctor(DoctorDTO doctorDTO) {
		...
		employeeDTO.setFirstName(doctorDTO.name().split(" ")[0]);
		employeeDTO.setLastName(doctorDTO.name().split(" ")[1]);
		employeeDTO.setDepartmentName(doctorDTO.specialty().name().toString());
		EmployeeDTO data = employeeServiceClient.addEmployees(employeeDTO);
		doctor.setEmployeeFk(data.getEmployeeID());
